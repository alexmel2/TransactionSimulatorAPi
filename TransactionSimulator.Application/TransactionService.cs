...
namespace Application
{
    ...
    public class TransactionService : ITransactionService
    {
        ...
        public TransactionService(IApplicationDbContext context, IOptions<AppSettings> settings)
        {
        ...
        public string ValidateTransaction(DateTime SubmittedTimeUtc, string timeZoneId)
        {
            ...
            return (localTime.TimeOfDay >= open && localTime.TimeOfDay < close) ? "Approved" : "Rejected";
        }
    }
}
